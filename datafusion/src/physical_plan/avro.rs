...
use super::{common, source::Source, source::SeekRead, ExecutionPlan, Partitioning, LambdaExecPlan};
...
#[async_trait]
impl LambdaExecPlan for AvroExec {
    fn feed_batches(&mut self, _partitions: Vec<Vec<RecordBatch>>) {
        unimplemented!("AvroExec::feed_batches");
    }
}

#[async_trait]
#[typetag::serde(name = "avro_exec")]
