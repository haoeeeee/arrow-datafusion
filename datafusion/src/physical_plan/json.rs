...
use super::{
    common, source::Source, source::SeekRead, ExecutionPlan, Partitioning, RecordBatchStream, Statistics,
    LambdaExecPlan,
};
...
#[async_trait]
impl LambdaExecPlan for NdJsonExec {
    fn feed_batches(&mut self, _partitions: Vec<Vec<RecordBatch>>) {
        unimplemented!("NdJsonExec::feed_batches");
    }
}

#[async_trait]
#[typetag::serde(name = "nd_json_exec")]
